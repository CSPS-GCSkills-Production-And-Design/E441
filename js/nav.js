...
function navStructure() {
        ...
        this.populate = function () {
                ...
                this.loadExt(); //load external link list
        ...
        this.isLoaded = function () {
			...
			if(trackViewedSubs){
				...
				for(i=0;i<masterStructure.subs.length;i++){
					this.stringViewed += this.subs[i].saveViewedSubs();	
				}				
				trackingObj.saveData("vp",this.stringViewed);
			}
...
function objScorm() {
	...
	this.initLessonStatus=function(){
		if (this.getStatus()=="online"){
			var currentStatus=window.opener.doLMSGetValue("cmi.core.lesson_status");
